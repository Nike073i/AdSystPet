...
{
    public class OrderStatusUpdatedEventNotifySellerConsumer : UserNotifierConsumer<OrderStatusUpdatedEvent>
    {
        public OrderStatusUpdatedEventNotifySellerConsumer(
            ILogger<OrderStatusUpdatedEventNotifySellerConsumer> logger,
        ...
        protected override Guid GetReceiverId(OrderStatusUpdatedEvent eventModel) => eventModel.SellerId;
    }
}
