...
{
    public class OrderCanceledEventNotifySellerConsumer : UserNotifierConsumer<OrderCanceledEvent>
    {
        public OrderCanceledEventNotifySellerConsumer(
            ILogger<OrderCanceledEventNotifySellerConsumer> logger,
        ...
        protected override Guid GetReceiverId(OrderCanceledEvent eventModel) => eventModel.SellerId;
    }
}
