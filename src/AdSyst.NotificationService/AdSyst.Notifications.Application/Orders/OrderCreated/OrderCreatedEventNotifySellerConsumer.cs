...
{
    public class OrderCreatedEventNotifySellerConsumer : UserNotifierConsumer<OrderCreatedEvent>
    {
        public OrderCreatedEventNotifySellerConsumer(
            ILogger<OrderCreatedEventNotifySellerConsumer> logger,
        ...
        protected override Guid GetReceiverId(OrderCreatedEvent eventModel) => eventModel.SellerId;
    }
}
